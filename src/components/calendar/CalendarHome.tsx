...
import { ChevronLeft, ChevronRight, Plus, Flame, Trophy, Activity, Dumbbell, ArrowRight } from "lucide-react";
...
export function CalendarHome({
  ...
  const monthStats = useMemo(() => {
    ...
    return { days, xp, count: monthSessions.length };
  }, [sessions, cursorYM]);
    ...
    <div className="space-y-6 pb-24">
      ...
      {selectedDate && (
        <SessionDetailSheet
          ...
          techniqueByRecordId={techniqueByRecordId}
          sequenceByRecordId={sequenceByRecordId}
